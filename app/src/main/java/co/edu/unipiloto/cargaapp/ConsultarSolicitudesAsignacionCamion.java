...
public class ConsultarSolicitudesAsignacionCamion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultar_solicitudes_asignacion_camion);
        ...
        try {
            ...
            consulta=admin.getSolicitudCargaAplicadas(baseDatos,tablaText.split(" ")[1]);
            ...
            ListView listSolicitudesCarga=(ListView)findViewById(R.id.list_consultar_solicitudes_aplicadas);
            ...
            AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    Intent intent= new Intent(ConsultarSolicitudesAsignacionCamion.this,AsignarCamion.class);
                    intent.putExtra(AsignarCamion.NOMBRE_USE, tablaText+" "+id);
