...
public class ConsultaRecoleccionCarga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_recoleccion_carga);
        ...
        try {
            ...
            ListView listSolicitudesCarga=(ListView)findViewById(R.id.list_consultar_solicitudes_por_camion);
            ...
            AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    Intent intent= new Intent(ConsultaRecoleccionCarga.this,RecogerCarga.class);
                    intent.putExtra(RecogerCarga.NOMBRE_USE, tablaText+" "+id);
